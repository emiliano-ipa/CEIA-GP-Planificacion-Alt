...
\titulo{Planificación financiera inteligente en productos secos del ciclo III: predicción de demanda, márgenes y simulación de escenarios con Inteligencia Artificial} 
...
\fechaINICIO{28 de abril de 2025}		%Fecha de inicio de la cursada de GdP \fechaInicioName
...
La creciente necesidad de integrar datos en tiempo real con herramientas predictivas en la toma de decisiones empresariales representa uno de los desafíos más relevantes en los entornos industriales actuales. En ese marco, el presente proyecto propone el desarrollo de un sistema inteligente de planificación financiera para la familia de productos secos del ciclo III de la empresa Cagnoli S.A., utilizando modelos de inteligencia artificial (IA) orientados a la predicción de demanda, análisis de márgenes y simulación de escenarios.
...
Equipo        & miembro1 \newline 
				miembro2          &              	&        	\\ \hline
Opositores    &                   &              	&        	\\ \hline
Usuario final & Analistas de Planificación                  &              	&        	\\ \hline
\end{tabularx}
\end{table}
